          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-8">
            <div>
              ...
              <ul className="space-y-2.5">
                {[
                  { label: 'UMP Academy', href: 'https://academy.unamamaconproposito.co' },
            ...
            <div>
              ...
              <ul className="space-y-2.5">
                ...
                <li>
                  <a href="https://academy.unamamaconproposito.co" target="_blank" rel="noopener noreferrer" className="text-brand-gray hover:text-brand-brown text-sm transition-colors">
                    UMP Academy
                  </a>
                </li>
              </ul>
